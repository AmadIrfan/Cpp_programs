...
// _____________________________ Data Structures

int lives = 3;     // for lives
int score = 0;     // for score
int highscore = 0; // for high score
...
// _____________________________ Function Prototypes
...
void LoadinghighScore();                    // function for loading high score from file
void storingHighScore();                    // function for storing high score into file
void chngingHighScore();                    // function for comparing score and high score

main() // main function
{
    readTrack();        // reading track from file
    LoadinghighScore(); // reading high score from file
...
{
    chngingHighScore();             // comparing high score and our score
    SetConsoleTextAttribute(h, 14); // for yellow color
    gotoxy(x, y);
    cout << " HIGHSCORE : " << highscore; // displaying high score
    gotoxy(x, y + 2);
...
// function for loading high score from file
void LoadinghighScore()
{
    fstream file;
    file.open("HighScore.txt", ios::in); // opening file

    file >> highscore; // reading high score

    file.close(); // closing file
}

// function for checking score and high score
void chngingHighScore()
{

    if (score > highscore) // if score greater than high score
    {
        highscore = score; // change high core value
    }
}

// function for storing high score into file
void storingHighScore()
{
    fstream file;
    file.open("HighScore.txt", ios::out); // opening file

    file << highscore; // storing high score
