...
main()
{
    ...
    while (true)
    {
        ...
        else if (who == "STUDENT" || who == "student")
        {
            char studentOption = ' ';
            while (true)
            {
...
{ //__________Get student data and their preferences__________addStudentIntoArray();
    ...
    cin >> student_name[MAX_RECORDS];
    cout << "Enter your Fsc Marks";
    cin >> student_fsc[MAX_RECORDS];
    cout << "Enter your Ecat Marks";
    cin >> student_ecat[MAX_RECORDS];
    cout << "Enter your Matric Marks";
    cin >> student_matric[MAX_RECORDS];
}
